...
import { diameterAdjective, diameterProportion, populationAdjective, numberWithCommas } from './PlanetCardsCalculations';

export default function PlanetCardsDescription({planet}) {
  return (
    <div className="PlanetCards__Description">
      <h4>Description</h4>
